        ...
        <div class="container">
          ...
          >
            ...
            >
              ...
              >
                <router-link to="/" rel="home" itemprop="item">
              ...
              >
                <span itemprop="name">Über Weazel News</span>
            ...
            <main id="main" class="site-main">
              ...
              >
                <header class="entry-header">
                  <h1 class="entry-title">Über Weazel News</h1>
                </header>
                <!-- .entry-header -->

                <div class="entry-content" v-html="aboutus.text"></div>
                <!-- .entry-content -->
              </div>
              <!-- #post-73 -->
            </main>
